...
<form action="{{route('register')}}" method="post" class="px-8 py-4 mt-4 border-2 border-gray-400">
   @csrf
    <div class="w-full">
      <label for="" class="block">Name</label>
      <input type="text" name="name" id="" class="appearance-none mt-4">
    </div>
     <div class="w-full">
     ...
     <div class="w-full">
      <label for="" class="block">Password</label>
      <input type="password" name="password_confirmation" id="" class="appearance-none focus:shadow-outline text-black focus:text-gray-600 mt-4">
    </div>
